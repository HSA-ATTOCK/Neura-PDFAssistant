...
function App() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await axios.post("https://bf90-35-199-11-180.ngrok-free.app/upload", formData);
      setPdfUploaded(true);
  ...
  const sendQuestion = async () => {
    ...
    try {
      const res = await axios.post("https://bf90-35-199-11-180.ngrok-free.app/ask", { question });
